        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            ...
            <?php }
                    ...
                    $fnrv = 'RF_'.str_replace(".","&",str_replace("/","@",$pur_noku)).'_'.str_replace(".","&",str_replace("/","@",$person_no));
                    $fnpy = 'PY_'.str_replace(".","&",str_replace("/","@",$pur_noku)).'_'.str_replace(".","&",str_replace("/","@",$person_no));
                    $fnnp = 'NP_'.str_replace(".","&",str_replace("/","@",$pur_noku)).'_'.str_replace(".","&",str_replace("/","@",$person_no));
                    $fnpj = 'PJ_'.str_replace(".","&",str_replace("/","@",$pur_noku)).'_'.str_replace(".","&",str_replace("/","@",$person_no));
                ...
                ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12 up-img row">
                      ...
                      <div class="col-sm-12">
                        <a href="<?php echo ($pj_img);?>" target="_blank" type="button" class="btn btn-success rounded mx-auto d-block mb-4" download>Download Nota Pajak</a>
                      </div>
                      ...
                      <div class="col-sm-12">
                        <a href="#" type="button" class="btn btn-success rounded mx-auto d-block mb-4 disabled">Download Nota Pajak</a>
                      </div>   
                      <?php
                        }
                      ?>
                      ...
                      <form enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group mb-1">
                          ...
                          <p class="fst-italic text-danger" style="font-size: 12px;">*Nota > 1 lembar gunakan PDF</p>
                              ...
                              <input type="text" name="pur_noku" value="<?php echo $pur_noku; ?>" hidden>
                              <input type="text" name="person_no" value="<?php echo $person_no; ?>" hidden>
                         <div class="form-group row">
                          <div class="col-sm-10">
                            <a href="#" type="button" name="putih" class="btn btn-warning mx-auto btn-block" onclick="upload_nputih('<?php echo $fnnp; ?>');">Upload Nota Putih</a>
                          </div>
                          <div class="col-sm-2">
                            <?php
                              if ($pt_img <> '') {
                      ...
                      <form enctype="multipart/form-data" method="POST">
                       ...
                       <!--  <div class="form-group row" id="bt-pj-form">
                        ...
                        <div class="form-group row" id="up-pj2">
                          <div class="col-sm-10">
                            <a href="#" type="button" id="bt-dt-pjk" name="pajak" class="btn btn-warning mx-auto btn-block" >Upload Nota Pajak</a>
                          </div>
                          <div class="col-sm-2">
                            <?php
                              if ($pj_img <> '') {
                    ...
                    <div class="row">
                      <div class="col-sm-12 up-img">
                        <form enctype="multipart/form-data" method="POST">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-10">
                              <a href="#" type="button" name="receive" id="rc" class="btn btn-warning mx-auto btn-block" onclick="upload_receive('<?php echo $fnrv; ?>');">Upload Tanda Terima</a>
                            </div>
                            <div class="col-sm-2">
                              <?php
                                if ($rf_img <> '') {
                      ...
                      <div class="col-sm-12 up-img">
                        <form enctype="multipart/form-data" method="POST">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-10">
                              <a href="#" type="button" name="payment" id="py" class="btn btn-warning mx-auto btn-block " onclick="upload_payment('<?php echo $fnpy; ?>');" >Upload Bukti Pembayaran</a>
                            </div>
                            <div class="col-sm-2">
                              <?php
                                if ($py_img <> '') {
